...
class CodeEditor(QPlainTextEdit):
    def __init__(self):
        ...
        self.highlight_line_color = QColor(226, 248, 255)
    ...
    def line_number_area_paint_event(self, event):
        ...
        while block.isValid() and top <= event.rect().bottom():
            if block.isVisible() and bottom >= event.rect().top():
                ...
                painter.drawText(0, int(top), self.line_number_area.width() - 10, self.fontMetrics().height(),
    ...
    def setHighlightLineColor(self, col = None):
        if col is not None:
            self.highlight_line_color = col
            self.highlight_current_line()

    def resetHighlightLineColor(self):
        self.highlight_line_color = QColor(226, 248, 255)
        self.highlight_current_line()
    ...
    def highlight_current_line(self):
        ...
        if not self.isReadOnly():
            ...
            selection.format.setBackground(self.highlight_line_color)
...
class InputPane(QWidget):
    ...
    def createMenu(self):
        ...
        self.file_new_act.setStatusTip('New file.')

        self.file_open_act = QAction("Open / Insert...", self)
        if self.IncludeShortcuts:
            self.file_open_act.setShortcut('Ctrl+O')
        self.file_open_act.triggered.connect(self.openFile)
        self.file_open_act.setStatusTip('Open and insert a text file at the current cursor position.')
        ...
        self.file_saveas_act.setStatusTip('Save to a text file.')
        ...
        self.edit_copy_act.setStatusTip('Copy the currently selected text to the clipboard.')
        ...
        self.edit_copyAll_act.setStatusTip('Copy the entire document to the clipboard.')
        ...
        self.edit_paste_act.setStatusTip('Paste clipboard text into the document.')
        ...
        self.edit_selectall_act.setStatusTip('Select all of the text.')
        ...
        self.edit_undo_act.setStatusTip('Undo the last document change.')
        ...
        self.edit_redo_act.setStatusTip('Redo the last document change.')
        ...
        self.tool_string_removeWS_act.setStatusTip('Remove all whitespace from the text.')
        ...
        self.tool_string_removeWSperLine_act.setStatusTip('Remove all whitespace from each line but do not join lines.')
        ...
        self.tool_string_removeWStoSpace_act.setStatusTip('Convert all whitespace to single spaces.')
        ...
        self.tool_string_removePunct_act.setStatusTip('Remove all punctuation from the text.')
        ...
        self.tool_string_removeNumbers_act.setStatusTip('Remove all numbers from the text.')
        ...
        self.tool_string_removeNonLetters_act.setStatusTip('Remove all non-letters from the text.')
        ...
        self.tool_string_split_act.setStatusTip('Split document by converting spaces into line breaks.')
        ...
        self.tool_string_join_act.setStatusTip('Join lines by converting line breaks into spaces.')
        ...
        self.tool_string_removeBlankLines_act.setStatusTip('Remove all blank lines.')
        ...
        self.tool_string_removeMultipleBlankLines_act.setStatusTip('Convert multiple blank lines into one blank line.')
        ...
        self.tool_string_removeFrontWS_act.setStatusTip('Remove the whitespace from the front of each line.')
        ...
        self.tool_string_removeEndWS_act.setStatusTip('Remove the whitespace from the end of each line.')

        self.tool_string_TrimLines_act = QAction("Trim Lines", self)
        self.tool_string_TrimLines_act.triggered.connect(self.trimAllLines)
        self.tool_string_TrimLines_act.setStatusTip('Remove the whitespace from the  fron and end of each line.')
        ...
        self.tool_string_ReplaceAll_act.setStatusTip('Replace all occurrences of a string with another asring.')

        self.tool_string_SplitAt_act = QAction("Split At...", self)
        self.tool_string_SplitAt_act.triggered.connect(self.splitAt)
        self.tool_string_SplitAt_act.setStatusTip('Split the string over the given substring.')
        ...
        self.tool_string_BreakCharStream_act.setStatusTip('Break the character string into specified lengths.')
        ...
        self.tool_string_ReformatCharStream_act.setStatusTip('Reformat the text to specified lengths.')
        ...
        self.tool_string_RemoveDoubleChars_act.setStatusTip('Remove double characters.')
        ...
        self.tool_char_AZ_1_26B_8_act.setStatusTip('Convert the characters A-Z to the values 1-26 in 8-bit binary form.')
        ...
        self.tool_char_AZ_0_25B_8_act.setStatusTip(
            'Convert the characters A-Z to the values 0-25 in 8-bit binary form.')

        self.tool_Text_Ascii_act = QAction("Text -> ASCII", self)
        self.tool_Text_Ascii_act.triggered.connect(self.TextASCII)
        self.tool_Text_Ascii_act.setStatusTip('Convert the characters into their ASCII values.')

        self.tool_Text_Ascii3_act = QAction("Text -> ASCII:  3-Digits", self)
        self.tool_Text_Ascii3_act.triggered.connect(self.TextASCII3)
        self.tool_Text_Ascii3_act.setStatusTip('Convert the characters into their ASCII values using 3 digits for each.')

        self.tool_Text_AsciiB_act = QAction("Text -> ASCII:  Binary", self)
        self.tool_Text_AsciiB_act.triggered.connect(self.TextASCIIB)
        self.tool_Text_AsciiB_act.setStatusTip('Convert the characters into their ASCII values in binary form.')
        ...
        self.tool_num_RemoveZeros_act.setStatusTip('Remove leading zeros from all numbers.')
        ...
        self.tool_code_SpaceTab_act.setStatusTip('Convert spaces to tabs.')
        ...
        self.tool_code_RemoveComments_act.setStatusTip('Remove C++/Java style comments from the text.')
        ...
        self.tool_code_CodeString_act.setStatusTip('Convert text to a C++ code string.')

        self.tool_code_Condense_act = QAction("Condense", self)
        self.tool_code_Condense_act.triggered.connect(self.Condense)
        self.tool_code_Condense_act.setStatusTip('Condense the text by removing blank lines, comments, and ending whitespace.')
        ...
        self.tool_code_CondenseConvert_act.setStatusTip(
            'Condense the text and convert it to a C++ code string.')
        ...
        self.tool_rand_Int_act.setStatusTip('Generate uniformly distributed pseudo-random integers.')

        self.tool_rand_Float_act = QAction("Uniform Float Range...", self)
        self.tool_rand_Float_act.triggered.connect(self.RandFloatRange)
        self.tool_rand_Float_act.setStatusTip('Generate uniformly distributed pseudo-random floating point numbers.')
        ...
        self.tool_rand_Binomial_act.setStatusTip('Generate binomial distributed pseudo-random numbers.')

        self.tool_rand_Normal_act = QAction("Normal Distribution...", self)
        self.tool_rand_Normal_act.triggered.connect(self.RandNormal)
        self.tool_rand_Normal_act.setStatusTip('Generate normal distributed pseudo-random numbers.')
        ...
        self.tool_rand_LogNormal_act.setStatusTip('Generate log-normal distributed pseudo-random numbers.')
        ...
        self.tool_rand_ExpDist_act.setStatusTip('Generate exponentially distributed pseudo-random numbers.')

        self.tool_rand_BBS_act = QAction("Blum-Blum-Shub Bit Generator...", self)
        self.tool_rand_BBS_act.triggered.connect(self.RandBBS)
        self.tool_rand_BBS_act.setStatusTip('Generate a pseudo-random bit stream with the Blum-Blum-Shub algorithm.')
    ...
    def getSelection(self):
        """ Returns the selected text and the beginning and ending character positions of the selection. """
        start, end = self.editor.textCursor().selectionStart(), self.editor.textCursor().selectionEnd()
    ...
    def toupper(self):
        ...
        self.editor.insertPlainText(self.getSelectionString().upper())

    def tolower(self):
        """ Converts all text in the editor to lowercase. """
        self.editor.insertPlainText(self.getSelectionString().lower())

    def tocaps(self):
        """ Capitalizes each word in the editor. """
        text = self.getSelectionString()
        retstr = ""
        pos = 0
        lastpos = 0
        while pos < len(text):
            if text[pos].isspace():
                word = text[lastpos:pos]
                word = word.capitalize()
                retstr += word + text[pos]
                lastpos = pos + 1
            pos += 1
        ...
        self.editor.insertPlainText(retstr)

    def removeAllWhitespace(self, text):
    ...
    def remAllWS(self):
        ...
        self.editor.insertPlainText(self.removeAllWhitespace(self.getSelectionString()))

    def removeWhitespacePerLine(self, text):
    ...
    def remWSperLine(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.removeWhitespacePerLine(self.getSelectionString()))

    def WStoSingleSpace(self, text):
    ...
    def splitString(self, text):
        ...
        repstr = self.WStoSpace(text)
        return repstr.replace(' ', '\n')

    def joinString(self, text):
    ...
    def removeMultipleBlankLines(self, text):
    ...
    def trimLines(self, text, trimfront=True, trimback=True):
        """
    ...
    def remWStoSingleSpace(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.WStoSingleSpace(self.getSelectionString()))
    ...
    def remPunct(self):
        ...
        for i in range(len(text)):
            if text[i].isalnum() or text[i].isspace():
                repstr += text[i]
        self.editor.insertPlainText(repstr)
    ...
    def splitAct(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.splitString(self.getSelectionString()))

    def joinAct(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.joinString(self.getSelectionString()))

    def remBlankLines(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.removeBlankLines(self.getSelectionString()))

    def remMultipleBlankLines(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.removeMultipleBlankLines(self.getSelectionString()))

    def remFrontWS(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.trimLines(self.getSelectionString(), True, False))

    def remEndWS(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.trimLines(self.getSelectionString(), False, True))

    def trimAllLines(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.trimLines(self.getSelectionString()))
    ...
    def replaceALL(self):
        ...
        dialog = TwoStringInputDialog(self, "Replace All", "Input target and replacement strings.", "Target:",
                                      "Replacement:", 200)
        if dialog.exec():
            self.editor.insertPlainText(self.getSelectionString().replace(dialog.getText1(), dialog.getText2()))
    ...
    def splitAt(self):
        ...
        dialog = StringInputDialog(self, "Split At", "Input string to use a split delimiter.", "Split String:",
                                   200)
        if dialog.exec():
            strlist = self.getSelectionString().split(dialog.getText())
            retstr = ""
            for text in strlist:
                retstr += text + '\n'
            self.editor.insertPlainText(retstr)

    def charStreamBreak(self, text, numChars, joinLines, presWords):
        """
        ...
        if joinLines:
            text = self.WStoSingleSpace(text)
    ...
    def breakCharStream(self):
        ...
        if dialog.exec():
            self.editor.insertPlainText(self.charStreamBreak(self.getSelectionString(), dialog.getNum(), False, dialog.getPreserveWords()))
    ...
    def reformatCharStream(self):
        ...
        if dialog.exec():
            self.editor.insertPlainText(self.charStreamBreak(self.getSelectionString(), dialog.getNum(), True, True))
    ...
    def ConvertBaseGen(self):
        ...
        if dialog.exec():
            ...
            self.editor.insertPlainText(self.ConvertBaseGenString(self.getSelectionString(), oldbase, newbase))
    ...
    def PadZeros(self):
        ...
        if dialog.exec():
            ...
            istr = self.getSelectionString()
            istr = self.WStoSingleSpace(istr)
            numlist = istr.split(' ')
            retstr = ''
            for num in numlist:
                retstr += self.zeropad(num, padlength) + ' '
            self.editor.insertPlainText(retstr.strip())
    ...
    def RemoveZeros(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.stripLeadingZeros(self.getSelectionString(), 0))
    ...
    def RemoveZerosMinLength(self):
        ...
        dialog = OneNumberInputDialog(self, "Minimum Length",
                                      ...
                                      0, 1000, 8, 75)
        if dialog.exec():
            self.editor.insertPlainText(self.stripLeadingZeros(self.getSelectionString(), dialog.getVal()))

    def AZ_1_26(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.charCode(self.getSelectionString(), 1, 0))

    def AZ_0_25(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.charCode(self.getSelectionString(), 0, 0))

    def AZ_01_26(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.charCode(self.getSelectionString(), 1, 2))

    def AZ_00_25(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.charCode(self.getSelectionString(), 0, 2))

    def AZ_1_26B(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.charCode(self.getSelectionString(), 1, 0, False, True))
    def AZ_0_25B(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.charCode(self.getSelectionString(), 0, 0, False, True))

    def AZ_1_26B_8(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.charCode(self.getSelectionString(), 1, 8, False, True))

    def AZ_0_25B_8(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.charCode(self.getSelectionString(), 0, 8, False, True))

    def TextASCII(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.charCode(self.getSelectionString(), 0, 0, True))

    def TextASCIIB(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.charCode(self.getSelectionString(), 0, 0, True, True))

    def TextASCIIB_8(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.charCode(self.getSelectionString(), 0, 8, True, True))

    def TextASCII3(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.charCode(self.getSelectionString(), 0, 3, True))

    def Conv_1_26_AZ(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.charDecode(self.getSelectionString(), 1))

    def Conv_0_25_AZ(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.charDecode(self.getSelectionString(), 0))

    def Conv_1_26B_AZ(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.charDecode(self.getSelectionString(), 1, False, True))

    def Conv_0_25B_AZ(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.charDecode(self.getSelectionString(), 0, False, True))

    def ASCIIText(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.charDecode(self.getSelectionString(), 0, True, False))

    def ASCIIBText(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.charDecode(self.getSelectionString(), 0, True, True))

    def Convert_10_2(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.ConvertBaseGenString(self.getSelectionString(), 10, 2))

    def Convert_10_8(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.ConvertBaseGenString(self.getSelectionString(), 10, 8))

    def Convert_10_16(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.ConvertBaseGenString(self.getSelectionString(), 10, 16))

    def Convert_2_10(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.ConvertBaseGenString(self.getSelectionString(), 2, 10))

    def Convert_2_8(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.ConvertBaseGenString(self.getSelectionString(), 2, 8))

    def Convert_2_16(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.ConvertBaseGenString(self.getSelectionString(), 2, 16))

    def Convert_8_2(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.ConvertBaseGenString(self.getSelectionString(), 8, 2))

    def Convert_8_10(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.ConvertBaseGenString(self.getSelectionString(), 8, 10))

    def Convert_8_16(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.ConvertBaseGenString(self.getSelectionString(), 8,16))

    def Convert_16_2(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.ConvertBaseGenString(self.getSelectionString(), 16, 2))

    def Convert_16_8(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.ConvertBaseGenString(self.getSelectionString(), 16, 8))

    def Convert_16_10(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.ConvertBaseGenString(self.getSelectionString(), 16, 10))

    def ConvertTabSpace1(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.tabsToSpaces(self.getSelectionString(), 1))

    def ConvertTabSpace2(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.tabsToSpaces(self.getSelectionString(), 2))

    def ConvertTabSpace3(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.tabsToSpaces(self.getSelectionString(), 3))

    def ConvertTabSpace4(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.tabsToSpaces(self.getSelectionString(), 4))

    def ConvertTabSpace5(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.tabsToSpaces(self.getSelectionString(), 5))

    def ConvertSpaceTab(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.SpacesToTabs(self.getSelectionString()))
    ...
    def RemoveComments(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.RemoveCJCommentsFromString(self.getSelectionString()))
    ...
    def ConvertToCodeString(self):
        """ Intermediate menu call function. """
        self.editor.insertPlainText(self.ConvertToCPPCodeString(self.getSelectionString()))
    ...
    def Condense(self):
        ...
        self.editor.insertPlainText(istr)
