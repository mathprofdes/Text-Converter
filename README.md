...
- Download the **[TextConverter.exe](https://github.com/mathprofdes/Text-Converter/releases/download/v1.2.1/TextConverter.exe)** file.
...
- A png file of a program icon **[ProgramIcon.png](https://github.com/mathprofdes/Text-Converter/releases/download/v1.2.1/ProgramIcon.png)** is included if you wish to use it for a shortcut to the program.
...
![Screenshot of program.](https://github.com/mathprofdes/Text-Converter/releases/download/v1.2.1/TextConverterScreenshot.png)
